...
public class TemplatesConfiguration {
    ...
    /**
     * Returns the {@link Increment} with the given id
     * @param id
     *            of the {@link Increment} to be searched for
     * @return the {@link Increment} with the given id or <code>null</code> if there is no
     */
    public Increment getIncrement(String id) {
        return increments.get(id);
    }
     ...
     */
    public List<Increment> getAllIncrements() {
